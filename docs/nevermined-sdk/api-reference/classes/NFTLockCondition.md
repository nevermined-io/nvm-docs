...
- [client](NFTLockCondition.md#client)
...
- [publicClient](NFTLockCondition.md#publicclient)
- [walletClient](NFTLockCondition.md#walletclient)
...
- [getTransactionLogs](NFTLockCondition.md#gettransactionlogs)
...
- [someLog](NFTLockCondition.md#somelog)
...
• **new NFTLockCondition**(`contractName`): [`NFTLockCondition`](NFTLockCondition.md)
...
ConsumerCondition\<NFTLockConditionContext\>.constructor
...
▸ **fulfill**(`agreementId`, `did`, `rewardAddress`, `amount`, `from`, `txParams?`): `Promise`\<`any`\>
...
[src/keeper/contracts/conditions/NFTs/NFTLockCondition.ts:49](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/conditions/NFTs/NFTLockCondition.ts#L49)
...
▸ **params**(`did`, `rewardAddress`, `amount`): `ConditionParameters`\<`Record`\<`string`, `unknown`\>\>
...
[src/keeper/contracts/conditions/NFTs/NFTLockCondition.ts:31](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/conditions/NFTs/NFTLockCondition.ts#L31)
...
[src/keeper/contracts/conditions/NFTs/NFTLockCondition.ts:35](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/conditions/NFTs/NFTLockCondition.ts#L35)
...
▸ **getInstance**(`config`): `Promise`\<[`NFTLockCondition`](NFTLockCondition.md)\>
...
[src/keeper/contracts/conditions/NFTs/NFTLockCondition.ts:20](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/conditions/NFTs/NFTLockCondition.ts#L20)
