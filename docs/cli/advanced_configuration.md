...
* `NODE_URL` - The url of the NOde to use. If not given the default url is: `http://localhost:8030`
...
* `NODE_ADDRESS` - The public address of the node. If not given the default address is: `0x068ed00cf0441e4829d9784fcbe7b9e26d4bd8d0`
