...
- [client](MarketplaceApi.md#client)
...
- [publicClient](MarketplaceApi.md#publicclient)
- [url](MarketplaceApi.md#url)
- [walletClient](MarketplaceApi.md#walletclient)
...
• **new MarketplaceApi**(`config`): [`MarketplaceApi`](MarketplaceApi.md)
