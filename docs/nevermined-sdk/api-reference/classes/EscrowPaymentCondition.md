...
- `ProviderCondition`\<`EscrowPaymentConditionContext`\>
...
- [client](EscrowPaymentCondition.md#client)
...
- [publicClient](EscrowPaymentCondition.md#publicclient)
- [walletClient](EscrowPaymentCondition.md#walletclient)
...
- [getTransactionLogs](EscrowPaymentCondition.md#gettransactionlogs)
...
- [someLog](EscrowPaymentCondition.md#somelog)
...
• **new EscrowPaymentCondition**(`contractName`): [`EscrowPaymentCondition`](EscrowPaymentCondition.md)
...
[`EscrowPaymentCondition`](EscrowPaymentCondition.md)

#### Inherited from

ProviderCondition\<EscrowPaymentConditionContext\>.constructor
...
▸ **fulfill**(`agreementId`, `did`, `amounts`, `receivers`, `returnAddress`, `lockPaymentAddress`, `tokenAddress`, `lockCondition`, `releaseCondition`, `from`, `txParams?`): `Promise`\<`any`\>
...
[src/keeper/contracts/conditions/EscrowPaymentCondition.ts:57](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/conditions/EscrowPaymentCondition.ts#L57)
...
▸ **params**(`did`, `amounts`, `receivers`, `returnAddress`, `sender`, `tokenAddress`, `lockCondition`, `releaseCondition`): `ConditionParameters`\<`Record`\<`string`, `unknown`\>\>
...
[src/keeper/contracts/conditions/EscrowPaymentCondition.ts:18](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/conditions/EscrowPaymentCondition.ts#L18)

___

### paramsFromDDO

▸ **paramsFromDDO**(`«destructured»`, `access`, `lock`): `Promise`\<`ConditionParameters`\<`Record`\<`string`, `unknown`\>\>\>
...
[src/keeper/contracts/conditions/EscrowPaymentCondition.ts:37](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/conditions/EscrowPaymentCondition.ts#L37)
...
▸ **getInstance**(`config`): `Promise`\<[`EscrowPaymentCondition`](EscrowPaymentCondition.md)\>
...
[src/keeper/contracts/conditions/EscrowPaymentCondition.ts:14](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/conditions/EscrowPaymentCondition.ts#L14)
