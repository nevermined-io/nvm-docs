...
- [client](ConditionStoreManager.md#client)
...
- [publicClient](ConditionStoreManager.md#publicclient)
- [walletClient](ConditionStoreManager.md#walletclient)
...
- [getTransactionLogs](ConditionStoreManager.md#gettransactionlogs)
...
- [someLog](ConditionStoreManager.md#somelog)
...
• **new ConditionStoreManager**(`contractName`): [`ConditionStoreManager`](ConditionStoreManager.md)
...
▸ **createCondition**(`id`, `typeRef`, `from`, `txParams?`): `Promise`\<`any`\>
...
[src/keeper/contracts/managers/ConditionStoreManager.ts:27](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/managers/ConditionStoreManager.ts#L27)

___

### delegateCreateRole

▸ **delegateCreateRole**(`delegatee`, `owner`, `txParams?`): `Promise`\<`any`\>
...
[src/keeper/contracts/managers/ConditionStoreManager.ts:36](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/managers/ConditionStoreManager.ts#L36)
...
[src/keeper/contracts/managers/ConditionStoreManager.ts:56](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/managers/ConditionStoreManager.ts#L56)
...
[src/keeper/contracts/managers/ConditionStoreManager.ts:40](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/managers/ConditionStoreManager.ts#L40)
...
[src/keeper/contracts/managers/ConditionStoreManager.ts:52](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/managers/ConditionStoreManager.ts#L52)
...
[src/keeper/contracts/managers/ConditionStoreManager.ts:44](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/managers/ConditionStoreManager.ts#L44)
...
[src/keeper/contracts/managers/ConditionStoreManager.ts:48](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/managers/ConditionStoreManager.ts#L48)
...
▸ **getInstance**(`config`): `Promise`\<[`ConditionStoreManager`](ConditionStoreManager.md)\>
...
[src/keeper/contracts/managers/ConditionStoreManager.ts:19](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/managers/ConditionStoreManager.ts#L19)
