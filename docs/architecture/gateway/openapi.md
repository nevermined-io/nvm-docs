...
`GET /api/v1/gateway/services/compute/logs/{agreement_id}/{execution_id}`
...
`POST /api/v1/gateway/services/exec`
...
`GET /api/v1/gateway/services/nft-access/{agreement_id}`
