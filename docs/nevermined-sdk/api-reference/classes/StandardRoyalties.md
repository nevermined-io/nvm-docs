...
- [client](StandardRoyalties.md#client)
...
- [publicClient](StandardRoyalties.md#publicclient)
- [walletClient](StandardRoyalties.md#walletclient)
...
- [getTransactionLogs](StandardRoyalties.md#gettransactionlogs)
...
- [someLog](StandardRoyalties.md#somelog)
...
• **new StandardRoyalties**(`contractName`): [`StandardRoyalties`](StandardRoyalties.md)
...
▸ **getInstance**(`config`): `Promise`\<[`StandardRoyalties`](StandardRoyalties.md)\>
...
[src/keeper/contracts/royalties/StandardRoyalties.ts:5](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/royalties/StandardRoyalties.ts#L5)
