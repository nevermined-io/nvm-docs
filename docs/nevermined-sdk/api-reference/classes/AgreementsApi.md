...
- [client](AgreementsApi.md#client)
...
- [publicClient](AgreementsApi.md#publicclient)
- [walletClient](AgreementsApi.md#walletclient)
...
• **new AgreementsApi**(`config`): [`AgreementsApi`](AgreementsApi.md)
...
[src/nevermined/api/AgreementsApi.ts:28](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/nevermined/api/AgreementsApi.ts#L28)
...
[src/nevermined/api/AgreementsApi.ts:21](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/nevermined/api/AgreementsApi.ts#L21)
...
▸ **create**(`did`, `agreementIdSeed`, `serviceType`, `agreementParams`, `from`, `txParams?`): `Promise`\<`string`\>
...
| `agreementIdSeed` | `string` | Service agreement ID seed. |
| `serviceType` | [`ServiceType`](../code-reference.md#servicetype) | Service. |
| `agreementParams` | `any` | Agreement parameters. |
| `from` | [`NvmAccount`](NvmAccount.md) | The account of the user creating the service agreement |
...
[src/nevermined/api/AgreementsApi.ts:88](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/nevermined/api/AgreementsApi.ts#L88)
...
[src/nevermined/api/AgreementsApi.ts:140](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/nevermined/api/AgreementsApi.ts#L140)
...
[src/nevermined/api/AgreementsApi.ts:149](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/nevermined/api/AgreementsApi.ts#L149)

___

### isAccessGranted

▸ **isAccessGranted**(`agreementId`, `did`, `consumerAddress`, `from`): `Promise`\<`boolean`\>
...
| `from` | [`NvmAccount`](NvmAccount.md) | the user account |
...
[src/nevermined/api/AgreementsApi.ts:161](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/nevermined/api/AgreementsApi.ts#L161)

___

### prepareSignature

▸ **prepareSignature**(`did`, `serviceType`, `from`): `Promise`\<[`AgreementPrepareResult`](../interfaces/AgreementPrepareResult.md)\>
...
[src/nevermined/api/AgreementsApi.ts:45](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/nevermined/api/AgreementsApi.ts#L45)
...
| `extended` | `boolean` | `false` | If true returns a complete status with dependencies. |
...
[src/nevermined/api/AgreementsApi.ts:114](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/nevermined/api/AgreementsApi.ts#L114)
