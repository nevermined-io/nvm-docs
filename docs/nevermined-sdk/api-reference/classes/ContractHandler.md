...
- [getContractArtifact](ContractHandler.md#getcontractartifact)
...
[src/keeper/ContractHandler.ts:51](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L51)
...
[src/keeper/ContractHandler.ts:15](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L15)
...
[src/keeper/ContractHandler.ts:17](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L17)
...
[src/keeper/ContractHandler.ts:75](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L75)

___

### deployAbi

▸ **deployAbi**(`artifact`, `from`, `args?`): `Promise`\<\{ `abi`: `Abi` ; `address`: \`0x$\{string}\` ; `createEventFilter`: {} ; `estimateGas`: {} & {} ; `getEvents`: {} ; `read`: {} ; `simulate`: {} ; `watchEvent`: {} ; `write`: {}  }\>
...
[src/keeper/ContractHandler.ts:79](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L79)

___

### getContractArtifact

▸ **getContractArtifact**(`contractName`, `networkName`, `artifactsFolder`): `Promise`\<`any`\>
...
[src/keeper/ContractHandler.ts:87](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L87)

___

### getContractFromArtifacts

▸ **getContractFromArtifacts**(`what`, `optional?`, `artifactsFolder`, `address?`): `Promise`\<`any`\>
...
[src/keeper/ContractHandler.ts:130](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L130)

___

### getVersionFromArtifact

▸ **getVersionFromArtifact**(`contractName`, `artifactsFolder`): `Promise`\<`string`\>
...
[src/keeper/ContractHandler.ts:56](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L56)

___

### loadContractFromAbi

▸ **loadContractFromAbi**(`what`, `where`, `networkId`, `artifactsFolder`, `address?`): `Promise`\<`any`\>
...
[src/keeper/ContractHandler.ts:105](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L105)
...
[src/keeper/ContractHandler.ts:181](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L181)

___

### getABIArtifact

▸ **getABIArtifact**(`contractName`, `artifactsFolder?`, `networkName?`): `Promise`\<`any`\>
...
[src/keeper/ContractHandler.ts:154](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L154)

___

### getContract

▸ **getContract**(`what`, `networkId`, `address?`): `any`
...
[src/keeper/ContractHandler.ts:19](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L19)

___

### getHash

▸ **getHash**(`what`, `networkId`, `address?`): `string`
...
[src/keeper/ContractHandler.ts:47](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L47)
...
▸ **getVersion**(`what`, `networkId`, `address?`): `any`
...
[src/keeper/ContractHandler.ts:24](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L24)

___

### hasContract

▸ **hasContract**(`what`, `networkId`, `address?`): `boolean`
...
[src/keeper/ContractHandler.ts:41](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L41)

___

### setContract

▸ **setContract**(`what`, `networkId`, `contractInstance`, `address?`, `version?`): `void`
...
[src/keeper/ContractHandler.ts:29](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/ContractHandler.ts#L29)
