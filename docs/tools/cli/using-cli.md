...
Once you create an account and fund it, you are ready to start using the `ncli` to interact with different Nevermined networks.
...
And see the status of any of them:
...
In this example we are using a public url, but with Nevermined you also could:
...
One registered asset in Nevermined is composed of 2 parts:
