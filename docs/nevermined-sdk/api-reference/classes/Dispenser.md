...
- [publicClient](Dispenser.md#publicclient)
- [walletClient](Dispenser.md#walletclient)

### Methods

- [call](Dispenser.md#call)
- [getFromAddress](Dispenser.md#getfromaddress)
- [getTransactionLogs](Dispenser.md#gettransactionlogs)
...
• **new Dispenser**(`contractName`): [`Dispenser`](Dispenser.md)
...
▸ **requestTokens**(`amount`, `from`, `txParams?`): `Promise`\<`any`\>
...
[src/keeper/contracts/Dispenser.ts:14](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/Dispenser.ts#L14)
...
▸ **getInstance**(`config`): `Promise`\<[`Dispenser`](Dispenser.md)\>
...
[src/keeper/contracts/Dispenser.ts:8](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/Dispenser.ts#L8)
