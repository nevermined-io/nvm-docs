...
- [client](RewardsDistributor.md#client)
...
- [publicClient](RewardsDistributor.md#publicclient)
- [walletClient](RewardsDistributor.md#walletclient)
...
- [getTransactionLogs](RewardsDistributor.md#gettransactionlogs)
...
- [someLog](RewardsDistributor.md#somelog)
...
• **new RewardsDistributor**(`contractName`): [`RewardsDistributor`](RewardsDistributor.md)
...
▸ **claimReward**(`agreementId`, `did`, `amounts`, `receivers`, `returnAddress`, `lockPaymentAddress`, `tokenAddress`, `lockCondition`, `releaseConditions`, `from`, `txParams?`): `Promise`\<`any`\>
...
[src/keeper/contracts/royalties/RewardsDistributor.ts:22](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/royalties/RewardsDistributor.ts#L22)
...
▸ **setReceivers**(`did`, `addr`, `from`, `params?`): `Promise`\<`any`\>
...
[src/keeper/contracts/royalties/RewardsDistributor.ts:19](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/royalties/RewardsDistributor.ts#L19)
...
▸ **getInstance**(`config`): `Promise`\<[`RewardsDistributor`](RewardsDistributor.md)\>
...
[src/keeper/contracts/royalties/RewardsDistributor.ts:9](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/royalties/RewardsDistributor.ts#L9)
