  ...
  return (
    <>
      <UiForm>
        ...
        <UiButton title="Search" type="secondary" onClick={onSearchByPriceRange}>
          Search
        </UiButton>
      </UiForm>
  ...
  return (
    <>
      <UiForm>
        ...
        />
        <UiButton title="Search" type="secondary" onClick={onSearchByFilters}>
          Search
        </UiButton>
      </UiForm>
      ...
      {ddos.slice(0, 3).map((ddo) => (
        <UiLayout key={ddo.id} className={b('item')}>
          ...
          <UiLayout>
            <UiText>Price: </UiText>
            <UiText>
              {ddo.service[2].attributes.additionalInformation.priceHighestDenomination}
            </UiText>
          </UiLayout>
        </UiLayout>
      ))}
