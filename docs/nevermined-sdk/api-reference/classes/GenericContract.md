[@nevermined-io/sdk](../code-reference.md) / GenericContract
...
- [constructor](GenericContract.md#constructor)

### Properties

- [address](GenericContract.md#address)
- [contract](GenericContract.md#contract)
- [contractName](GenericContract.md#contractname)
- [events](GenericContract.md#events)
- [fixedAddress](GenericContract.md#fixedaddress)
- [version](GenericContract.md#version)

### Accessors

- [artifactsFolder](GenericContract.md#artifactsfolder)
- [circuitsFolder](GenericContract.md#circuitsfolder)
- [client](GenericContract.md#client)
- [config](GenericContract.md#config)
- [instanceConfig](GenericContract.md#instanceconfig)
- [instantiableConfig](GenericContract.md#instantiableconfig)
- [logger](GenericContract.md#logger)
- [nevermined](GenericContract.md#nevermined)
- [publicClient](GenericContract.md#publicclient)
- [walletClient](GenericContract.md#walletclient)

### Methods

- [call](GenericContract.md#call)
- [getContract](GenericContract.md#getcontract)
- [getFromAddress](GenericContract.md#getfromaddress)
- [getTransactionLogs](GenericContract.md#gettransactionlogs)
- [init](GenericContract.md#init)
- [send](GenericContract.md#send)
- [sendFrom](GenericContract.md#sendfrom)
- [setInstanceConfig](GenericContract.md#setinstanceconfig)
- [someLog](GenericContract.md#somelog)
- [getInstance](GenericContract.md#getinstance)
- [setInstanceConfig](GenericContract.md#setinstanceconfig-1)

## Constructors

### constructor

• **new GenericContract**(`contractName`, `address`): [`GenericContract`](GenericContract.md)
...
[src/keeper/contracts/GenericContract.ts:19](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/GenericContract.ts#L19)
...
[src/keeper/contracts/GenericContract.ts:7](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/GenericContract.ts#L7)
...
[src/keeper/contracts/GenericContract.ts:35](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/GenericContract.ts#L35)
...
[src/keeper/contracts/GenericContract.ts:43](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/GenericContract.ts#L43)
...
▸ **init**(`config`, `optional?`): `Promise`\<`void`\>
...
[src/keeper/contracts/GenericContract.ts:24](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/GenericContract.ts#L24)

___

### send

▸ **send**(`name`, `from`, `args`, `params?`): `Promise`\<`any`\>
...
[src/keeper/contracts/GenericContract.ts:39](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/GenericContract.ts#L39)
...
▸ **getInstance**(`config`, `contractName`, `address`): `Promise`\<[`GenericContract`](GenericContract.md)\>
...
[src/keeper/contracts/GenericContract.ts:9](https://github.com/nevermined-io/sdk-js/blob/4d0a0baa5afc98578a0eec8d32b14e61f501c376/src/keeper/contracts/GenericContract.ts#L9)
